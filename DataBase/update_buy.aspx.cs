...
namespace C09102014
{
	...
	/// WebForm1 的摘要描述。
	/// </summary>
	public class update_buy : System.Web.UI.Page
	{
		...
		{
			string updateCmd = "UPDATE buy SET 買方帳號 = @Id,  訂購數量 = @num, 出價 = @order, 拍賣編號 = @bid where  買方帳號 = @Id and 拍賣編號 = @bid";
