<%@ Page language="c#" Codebehind="delete_product.aspx.cs" AutoEventWireup="false" Inherits="C09102014.delete_product" %>
...
<HTML>
	...
	<body bgColor="#33ccff">
		<form id="Form1" method="post" runat="server">
			...
			<P align="center">
				<asp:datagrid id="MyDataGrid" runat="server" DataKeyField="拍賣編號" UseAccessibleHeader="True" CaptionAlign="Right"
