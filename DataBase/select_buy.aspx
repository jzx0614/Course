<%@ Page language="c#" Codebehind="select_buy.aspx.cs" AutoEventWireup="false" Inherits="C09102014.select_buy" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" bgColor="#33ccff">
		<form id="Form1" method="post" runat="server">
			<FONT face="新細明體">
				<asp:Button id="Button2" style="Z-INDEX: 108; LEFT: 440px; POSITION: absolute; TOP: 96px" runat="server"
					Width="80px" Text="取消"></asp:Button>
				<asp:TextBox id="TextBox5" style="Z-INDEX: 112; LEFT: 160px; POSITION: absolute; TOP: 144px"
					runat="server" Width="240px"></asp:TextBox>
				<asp:TextBox id="TextBox4" style="Z-INDEX: 111; LEFT: 160px; POSITION: absolute; TOP: 120px"
					runat="server" Width="240px"></asp:TextBox>
				<asp:Label id="Label6" style="Z-INDEX: 110; LEFT: 64px; POSITION: absolute; TOP: 144px" runat="server"
					Height="16px" Width="64px">拍賣編號</asp:Label>
				<asp:Label id="Label1" style="Z-INDEX: 109; LEFT: 64px; POSITION: absolute; TOP: 120px" runat="server"
					Height="16px" Width="64px">日期</asp:Label>
				<asp:datagrid id="MyDataGrid" style="Z-INDEX: 107; LEFT: 16px; POSITION: absolute; TOP: 200px"
				...
				<asp:TextBox id="TextBox3" style="Z-INDEX: 105; LEFT: 160px; POSITION: absolute; TOP: 96px" runat="server"
					Width="240px"></asp:TextBox>
				<asp:TextBox id="TextBox2" style="Z-INDEX: 104; LEFT: 160px; POSITION: absolute; TOP: 72px" runat="server"
					Width="240px"></asp:TextBox>
				<asp:Label id="Label4" style="Z-INDEX: 102; LEFT: 64px; POSITION: absolute; TOP: 96px" runat="server"
					Width="64px" Height="16px">出價</asp:Label>
				...
				<asp:Label id="Label2" style="Z-INDEX: 100; LEFT: 64px; POSITION: absolute; TOP: 48px" runat="server"
					Width="64px" Height="16px">買方帳號</asp:Label>
				<asp:TextBox id="TextBox1" style="Z-INDEX: 103; LEFT: 160px; POSITION: absolute; TOP: 48px" runat="server"
					Width="240px"></asp:TextBox>
				<asp:Button id="Button1" style="Z-INDEX: 106; LEFT: 440px; POSITION: absolute; TOP: 56px" runat="server"
