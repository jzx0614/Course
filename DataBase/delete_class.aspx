<%@ Page language="c#" Codebehind="delete_class.aspx.cs" AutoEventWireup="false" Inherits="C09102014.delete_class" %>
...
<HTML>
	...
	<body bgColor="#33ccff" ms_positioning="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<P align="center">
				<asp:datagrid id="MyDataGrid" runat="server" DataKeyField="類別編號" UseAccessibleHeader="True" CaptionAlign="Right"
